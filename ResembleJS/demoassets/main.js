$(function() {
    ...
    function onComplete(data) {
		...
		//resembleControl.outputSettings({ errorColor: { red: 255, green: 255, blue: 255}}).repaint(); // Changing the errorColor to white: 255, 255, 255
		$("#diffOnly").click();
		console.log("====>", data);
		console.log("======>", data.coordinatesForDiffRectangle);
